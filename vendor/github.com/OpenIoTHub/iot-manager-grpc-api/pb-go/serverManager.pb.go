...
var file_serverManager_proto_rawDesc = []byte{
	...
	0x4c, 0x69, 0x73, 0x74, 0x32, 0x9b, 0x02, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d,
...
var file_serverManager_proto_depIdxs = []int32{
	...
	4, // 6: pb.ServerManager.AddServer:output_type -> pb.OperationResponse
	4, // 7: pb.ServerManager.DelServer:output_type -> pb.OperationResponse
	4, // 8: pb.ServerManager.UpdateServer:output_type -> pb.OperationResponse
	1, // 9: pb.ServerManager.QueryServer:output_type -> pb.ServerInfoList
	1, // 10: pb.ServerManager.GetAllServer:output_type -> pb.ServerInfoList
